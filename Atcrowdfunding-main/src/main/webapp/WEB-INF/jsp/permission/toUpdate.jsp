...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.htm">众筹平台 - 许可维护</a></div>
        </div>
...
<script type="text/javascript">
   ...
   $("#updateBtn").click(function () {
       ...
       if ($.trim(furl)=="") {
           layer.msg("许可url不能为空,请重新输入！", {time:1000, icon:5, shift:6}, function () {
               //将之前许可输入的数据清除
               $("#furl").val("")
               furl.focus();
           });
       ...
       $.ajax({
           ...
           success:function (ajaxResult) {
               ...
               if (ajaxResult.success==true) {
                   layer.msg("修改成功",{time:1000,icon:5,shift:6});
                   //修改成功之后进行跳转到许可list页面
