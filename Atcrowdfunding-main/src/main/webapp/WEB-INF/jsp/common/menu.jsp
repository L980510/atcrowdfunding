...
<ul style="padding-left:0px;" class="list-group">
    ...
    <li class="list-group-item">
        ...
        <ul style="margin-top:10px;">
            ...
            <li style="height:30px;">
                <a href="${APP_PATH}/role/tolist.htm"><i class="glyphicon glyphicon-king"></i> 角色维护</a>
            </li>
            <li style="height:30px;">
                <a href="${APP_PATH}/permission/tolist.htm"><i class="glyphicon glyphicon-king"></i> 许可维护</a>
            </li>
        </ul>
    </li>
    <li class="list-group-item tree-closed">
