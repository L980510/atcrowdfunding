...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="${APP_PATH}/user.htm">众筹平台 - 用户维护</a></div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#updateBtn").click(function () {
            ...
            if ($.trim(floginAcct)=='') {
                layer.msg("用户名称不能为空,请重新输入！",{time:1000,icon:5,shift:6});
                //如果为空提示用户并且清空
                floginAcct.val("");
                floginAcct.focus();
            ...
            if ($.trim(femail)=="") {
                layer.msg("email不能为空,请重新输入！", {time:1000, icon:5, shift:6}, function () {
                    //将之前用户输入的数据清除
                    $("#femail").val("")
                    femail.focus();
                });
